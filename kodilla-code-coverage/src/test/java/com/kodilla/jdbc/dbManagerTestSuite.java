...
// Commented so as not to add more users to the Users table, I already have 41 of them...
//    @Test
...
//    }
    ...
    void testSelectUsersAndPosts() throws SQLException {
        ...
        while (rs.next()) {
            ...
            int postsCount = rs.getInt("POSTS");
            System.out.println("FirstName: " + firstName + ", LastName: " + lastName + ", PostsCount: " + postsCount);
